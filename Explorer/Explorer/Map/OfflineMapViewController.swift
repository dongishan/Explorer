...
//  MRT-CW1
//
//  Created by Gishan Don Ranasinghe on 10/03/2017.
...
class OfflineMapViewController: UIViewController, MGLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        mapView = MGLMapView(frame: view.bounds, styleURL: URL(string:"mapbox://styles/dongishan/cj04gacrq00af2sof160odvww"))
        ...
        mapView.setCenter(CLLocationCoordinate2D(latitude: 52.953297, longitude: -1.185393),
    ...
    func drawOverlayShapes() {
        ...
        mapView.addAnnotations([southwellHallPolygon, bicycleStoragePolygon, stopRA63ChairsPolygon, exchangeBicycleParkPolygon, siYuanBinPolygon, colinCampbelPondPolygon, vereCentrePolygon, benfordRoomAreaPolygon])
    }
}
